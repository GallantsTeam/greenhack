...
export async function sendTelegramMessage(
  botToken: string,
  chatId: string, // Should be string as Telegram chat_ids can be numeric or string (e.g. @channelname)
  message: string,
  ...
  const bodyPayload: any = {
    chat_id: chatId, // Send as string, Telegram API handles numeric strings
    text: message,
