...
const Header = ()=>{
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [navItems, setNavItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(staticDefaultNavItems);
    ...
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const fetchNavItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Header.useCallback[fetchNavItems]": async ()=>{
            ...
            try {
                ...
                if (data && data.length > 0) {
                    ...
                    const apiHrefs = new Set(data.map({
                        "Header.useCallback[fetchNavItems]": (item)=>item.href
                    }["Header.useCallback[fetchNavItems]"]));
                    const defaultHrefs = new Set(staticDefaultNavItems.map({
                        "Header.useCallback[fetchNavItems]": (item)=>item.href
                    }["Header.useCallback[fetchNavItems]"]));
                    data.forEach({
                        "Header.useCallback[fetchNavItems]": (apiItem)=>{
                            if (apiItem.is_visible) {
                                if (!defaultHrefs.has(apiItem.href)) {
                                    combinedItems.push(apiItem);
                                } else {
                                    const defaultItemIndex = combinedItems.findIndex({
                                        "Header.useCallback[fetchNavItems].defaultItemIndex": (item)=>item.href === apiItem.href
                                    }["Header.useCallback[fetchNavItems].defaultItemIndex"]);
                    ...
                    setNavItems(combinedItems.sort({
                        "Header.useCallback[fetchNavItems]": (a, b)=>(a.item_order || 0) - (b.item_order || 0)
                    }["Header.useCallback[fetchNavItems]"]));
                } else {
                    console.warn("[Header] API for navigation items returned empty or invalid data. Using static defaults.");
                    setNavItems(staticDefaultNavItems.sort({
                        "Header.useCallback[fetchNavItems]": (a, b)=>(a.item_order || 0) - (b.item_order || 0)
                    }["Header.useCallback[fetchNavItems]"]));
                }
            } catch (error) {
                ...
                setNavItems(staticDefaultNavItems.sort({
                    "Header.useCallback[fetchNavItems]": (a, b)=>(a.item_order || 0) - (b.item_order || 0)
                }["Header.useCallback[fetchNavItems]"])); // Fallback
            }
        }
    }["Header.useCallback[fetchNavItems]"], [
        toast
...
_s(Header, "bvJfvHDxtY0hYc+OIVglGLewHnc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
