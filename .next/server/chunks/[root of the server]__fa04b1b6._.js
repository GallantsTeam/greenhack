...
"[project]/.next-internal/server/app/api/user/notifications/read-all/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/user/notifications/read-all/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!userId || isNaN(parseInt(userId))) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Valid User ID is required in the request body.'
            }, {
                status: 400
            });
        }
        // TODO: Add authentication to ensure the requesting user matches userId or is an admin
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE user_notifications SET is_read = TRUE WHERE user_id = ? AND is_read = FALSE', [
            parseInt(userId)
        ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fa04b1b6._.js.map