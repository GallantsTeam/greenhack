...
async function GET(request) {
    ...
    try {
        const usersResultPromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT COUNT(*) as totalUsers FROM users');
        const productsResultPromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT COUNT(*) as totalProducts FROM products');
        const now = new Date();
        ...
        const monthlySalesResultPromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT SUM(amount_paid_gh) as monthlySalesGh 
       FROM purchases 
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4257601b._.js.map