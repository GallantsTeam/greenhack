...
"[project]/.next-internal/server/app/api/user/[userId]/referred-count/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/user/[userId]/referred-count/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT COUNT(*) as count FROM referrals WHERE referrer_user_id = ?', [
            parseInt(userId)
        ]);
        if (Array.isArray(results) && results.length > 0) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                count: 0
            }); // Default to 0 if no records or error
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__66b84099._.js.map