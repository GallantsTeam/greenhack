    ...
    try {
        ...
        if (!emailOrLogin || !password) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Missing email/login or password'
            }, {
                status: 400
            });
        }
        // Changed 'login' to 'username' in the SQL query
        const usersFound = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id, email, username, password_hash, role, balance, referral_code, referred_by_user_id FROM users WHERE email = ? OR username = ?', [
            emailOrLogin,
            emailOrLogin
        ]);
        ...
        const userFromDb = usersFound[0];
        const passwordMatch = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, userFromDb.password_hash || '');
        if (!passwordMatch) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Неверный email/логин или пароль.'
            }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__30193894._.js.map