...
"[project]/.next-internal/server/app/api/admin/site-settings/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET(request) {
    ...
    let settingsFromDb = {};
    try {
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM site_settings WHERE id = ? LIMIT 1', [
            SETTINGS_ROW_ID
        ]);
...
async function PUT(request) {
    try {
        ...
        if (updateFields.length === 0) {
            const currentSettingsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM site_settings WHERE id = ? LIMIT 1', [
                SETTINGS_ROW_ID
            ]);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(updateQuery, queryParams);
        const updatedSettingsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM site_settings WHERE id = ? LIMIT 1', [
            SETTINGS_ROW_ID
        ]);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Настройки сайта успешно обновлены.',
        ...
        if (error.code === 'ER_BAD_FIELD_ERROR' || error.message.includes('Unknown column')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Ошибка обновления: одна из колонок не существует в таблице 'site_settings'. Проверьте структуру таблицы или выполните предоставленный SQL-запрос для ее обновления. Детали: ${error.message}`
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__755bcdff._.js.map