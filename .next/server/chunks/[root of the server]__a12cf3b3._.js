...
"[project]/.next-internal/server/app/api/admin/site-banners/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/site-banners/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        const { title, subtitle, description, image_url, image_alt_text, button_text, button_link, item_order, is_active, hero_image_object_position, hero_image_hint, price_text, game_slug, related_product_slug_1, related_product_slug_2, related_product_slug_3 } = body;
        if (!title || !image_url) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    `;
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(insertQuery, params);
        let insertId;
        ...
        if (insertId) {
            const newBannerResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM site_banners WHERE id = ?', [
                insertId
            ]);
            const newBanner = {
                ...newBannerResult[0],
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Не удалось создать баннер в базе данных.'
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a12cf3b3._.js.map