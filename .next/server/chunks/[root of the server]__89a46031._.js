...
"[project]/.next-internal/server/app/api/inventory/delete/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/inventory/delete/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request) {
    try {
        ...
        console.log('[API Delete] Received request:', {
            userId,
            inventoryItemId
        });
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM user_inventory WHERE id = ? AND user_id = ?', [
            inventoryItemId,
            userId
        ]);
        if (result.affectedRows > 0) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Предмет успешно удален из инвентаря.'
            }, {
                status: 200
            });
        } else {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Предмет не найден или не принадлежит вам.'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__89a46031._.js.map