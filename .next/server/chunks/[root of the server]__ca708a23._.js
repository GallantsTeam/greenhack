...
"[project]/.next-internal/server/app/api/admin/faq-items/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/faq-items/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM faq_items ORDER BY item_order ASC, id ASC');
        const faqItems = results.map((item)=>({
                ...item,
                is_active: Boolean(item.is_active)
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(faqItems);
    } catch (error) {
        console.error('API Admin FAQ GET Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `Failed to fetch FAQ items: ${error.message}`
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    ...
    try {
        ...
        const { question, answer, item_order = 0, is_active = true } = body;
        if (!question || !answer) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO faq_items (question, answer, item_order, is_active) VALUES (?, ?, ?, ?)', [
            question,
            answer,
            item_order,
            is_active
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ca708a23._.js.map