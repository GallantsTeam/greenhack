...
"[project]/.next-internal/server/app/api/how-to-run-guides/[productSlug]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/how-to-run-guides/[productSlug]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
       ...
       WHERE htrg.product_slug = ?`, [
        ...
        if (results.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Инструкция для этого товара не найдена.'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b968dfde._.js.map