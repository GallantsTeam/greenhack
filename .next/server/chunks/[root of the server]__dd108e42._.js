...
"[project]/.next-internal/server/app/api/license/request-activation/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function POST(request) {
    try {
        ...
        console.log('[API RequestActivation] Received:', {
            inventoryItemId,
            userId,
            enteredKey
        });
        if (!inventoryItemId || !userId || !enteredKey) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Не все поля заполнены (ID предмета, ID пользователя, ключ).'
            }, {
                status: 400
            });
        }
       ...
       WHERE ui.id = ? AND ui.user_id = ?`, [
        ...
        if (inventoryItem.activation_status !== 'available' && inventoryItem.activation_status !== 'rejected') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Этот предмет уже ${inventoryItem.activation_status === 'pending_admin_approval' ? 'ожидает одобрения' : 'активирован или истек'}.`
            }, {
                status: 400
            });
        }
        ...
        const userResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id, username FROM users WHERE id = ?', [
            userId
        ]);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Запрос на активацию ключа отправлен администратору. Ожидайте подтверждения.'
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dd108e42._.js.map