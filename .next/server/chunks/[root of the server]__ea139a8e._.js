...
"[project]/.next-internal/server/app/api/admin/products/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET(request) {
    try {
        const productsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
       ...
       ORDER BY p.created_at DESC, p.name ASC`);
        if (!Array.isArray(productsData)) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Failed to retrieve products: unexpected database response format.'
            }, {
                status: 500
            });
        }
...
async function POST(request) {
    ...
    try {
        ...
        allOptionalFieldKeys.forEach((key)=>{
            if (optionalFieldsData[key] !== undefined) {
                if (key === 'gallery_image_urls' && Array.isArray(optionalFieldsData[key])) {
                    productFieldsToInsert[key] = optionalFieldsData[key].join(',');
                } else {
        ...
        const productResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(productInsertQuery, productParams);
        let productAffectedRows = 0;
        if (productResult && 'affectedRows' in productResult && !Array.isArray(productResult)) {
            productAffectedRows = productResult.affectedRows;
        ...
        if (productAffectedRows > 0) {
            ...
            const newProductDataResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
            p.*,
         ...
         WHERE p.id = ?`, [
            ...
            if (!Array.isArray(newProductDataResult) || newProductDataResult.length === 0) {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Товар создан, но не удалось получить его обновленные данные.'
                }, {
                    status: 500
                });
            }
        ...
        if (error.code === 'ER_TRUNCATED_WRONG_VALUE_FOR_FIELD') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Ошибка типа данных: Пожалуйста, проверьте правильность введенных числовых значений (например, цена, ID).`,
                error_details: error.toString()
            }, {
                status: 400
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ea139a8e._.js.map