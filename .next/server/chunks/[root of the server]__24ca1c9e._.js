...
"[project]/.next-internal/server/app/api/admin/faq-sidebar-items/[itemId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/faq-sidebar-items/[itemId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM faq_sidebar_nav_items WHERE id = ?', [
            id
        ]);
        if (!Array.isArray(results) || results.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'FAQ Sidebar Item not found'
            }, {
                status: 404
            });
        }
        const item = {
            ...
            content: results[0].content || null
        };
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `Failed to fetch FAQ sidebar item: ${error.message}`
        }, {
            status: 500
        });
    }
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        const { title, href, image_url, image_alt_text, data_ai_hint, content, item_order, is_active } = body;
    ...
    `;
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(updateQuery, queryParams);
        if (result.affectedRows > 0) {
            const updatedItem = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM faq_sidebar_nav_items WHERE id = ?', [
                id
            ]);
            const itemToReturn = {
                ...updatedItem[0],
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'FAQ sidebar item updated successfully',
                item: itemToReturn
            });
        } else {
            const currentItem = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT * FROM faq_sidebar_nav_items WHERE id = ?', [
                id
            ]);
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'No changes made to the FAQ sidebar item.',
                item: currentItem[0]
            });
        }
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `Failed to update FAQ sidebar item: ${error.message}`
        }, {
            status: 500
        });
    }
...
async function DELETE(request, { params }) {
    ...
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM faq_sidebar_nav_items WHERE id = ?', [
            id
        ]);
        if (result.affectedRows > 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'FAQ sidebar item deleted successfully'
            });
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'FAQ sidebar item not found'
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `Failed to delete FAQ sidebar item: ${error.message}`
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__24ca1c9e._.js.map