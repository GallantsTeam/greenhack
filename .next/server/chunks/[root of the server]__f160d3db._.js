...
"[project]/.next-internal/server/app/api/site-settings-public/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/site-settings-public/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const defaultSettingsOnError = {
            ...
            contact_vk_label: 'VK',
            contact_vk_url: '#',
            contact_telegram_bot_label: 'Telegram',
            contact_telegram_bot_url: '#',
            contact_email_label: 'Email',
            contact_email_address: 'error@example.com',
            footer_marketplace_text: 'Мы продаем на:',
            footer_marketplace_logo_url: 'https://yougame.biz/images/rlm/logo/logoconcept4.png',
            footer_marketplace_link_url: 'https://yougame.biz/members/263428/',
            footer_marketplace_is_visible: true,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f160d3db._.js.map