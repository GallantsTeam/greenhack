...
"[project]/.next-internal/server/app/api/user/[userId]/has-purchased/[productId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/user/[userId]/has-purchased/[productId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    if (!productId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Product ID (slug) is required'
        }, {
            status: 400
        });
    }
    try {
        ...
        const purchases = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT COUNT(*) as purchase_count FROM purchases WHERE user_id = ? AND product_id = ? AND status = ?', [
            parseInt(userId),
            productId,
            'completed'
        ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__84a02845._.js.map